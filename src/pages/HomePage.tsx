...
const skills = [
  ...
  "Frontend: React.js, Next.js, Tailwind CSS, Radix UI, Chakra UI",
  ...
  return (
    <section className="h-full">
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between pb-4 xl:pt-8 xl:pb-24">
          {/* Information about me */}
          <div className="text-center xl:text-left order-2 xl:order-none shadow-slate-200/20 shadow-md rounded-3xl px-7 py-4">
            ...
            <p className="max-w-[500px] xl:mx-0 mb-9 text-white/80">
